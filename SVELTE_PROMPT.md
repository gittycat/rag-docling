...
<task>
Create a Webapp SvelteKit service under /services for the project.
TECHNOLOGIES:
...
1. a Chat page that contains a ChatGPT like chat interface
2. a Documents page that allows the user to upload documents or a directory (containing documents) to the RAG system.
That page should also display a table that lists uploaded documents, and remove them.
3. A Dashboard page that will show metrics from the RAG system. Only create a placeholder for this page.
...
For the light mode, use the "nord" theme, also included in Svelte UX.
