<script lang="ts">
	...
	function persist() {
		const theme = checked ? darkTheme : 'nord';
...
<label class="swap swap-rotate inline-flex items-center justify-center w-10 h-10">
	<input type="checkbox" bind:checked onchange={persist} />
