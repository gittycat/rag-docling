...
| [eval-framework.md](eval-framework.md) | eval, evaluation, metrics, judge, deepeval, ragas, dashboard, api | Eval framework, metrics, LLM-as-judge, calibration, in-house vs third-party framework decision, eval service API (port 8002), dashboard metrics, running evals |
